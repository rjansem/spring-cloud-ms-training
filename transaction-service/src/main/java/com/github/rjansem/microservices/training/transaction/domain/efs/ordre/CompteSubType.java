...
public enum CompteSubType {
    ...
    CompteSubType(String type, String typeId, String libelle, String id) {
    ...
    public static CompteSubType findLibelleById(String type) {
        return Arrays.stream(CompteSubType.values()).filter(e -> e.getLibelle().equals(type)).findFirst()
